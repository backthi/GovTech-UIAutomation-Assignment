...
public class ProposalPage
{
    ...
    By startDateAlert_Text = By.xpath("//p[@id='react-project-start_date-alert']"); // Must be today or later - currentdate - 2 input
...
//            utils.clickElement(proposal_Link, 25);
    ...
    public boolean verifyDates()
    {
        ...
        try
        {
            js.executeScript("arguments[0].scrollIntoView();", driver.findElement(submitYourProposal_Text));
...
// react-project-attachments-0-btn-remove - Delete attachment
//  Delete Confirmation - Dialog
// bgp-btn bgp-btn-modal-delete - delete btn